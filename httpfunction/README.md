...
default-route-openshift-image-registry.apps.coffee.demolab.local
...
URL="http://httpfunction-test.apps.coffee.demolab.local/?message=$(whoami)"

curl "http://httpfunction-test.apps.coffee.demolab.local/?message=phil"